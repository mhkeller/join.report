  ...
  var steps = {
    'ready': function ready() {
      if (hasJoined() !== true) {
        ...
        var joinStratsContainer = inst.append('div').classed('join-strats-container', true);
        ...
        var joinStrategyDescsContainer = inst.append('div').classed('join-strategy-descs', true);

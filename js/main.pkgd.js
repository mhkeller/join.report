...
var commonjsGlobal$1 = typeof window !== 'undefined' ? window : typeof commonjsGlobal$2 !== 'undefined' ? commonjsGlobal$2 : typeof self !== 'undefined' ? self : {};
...
function join(dispatch) {
  ...
  function performJoin() {
    var datasets = getAll();
    var leftData = datasets.filter(function (d) {
      return d.order === 0;
    })[0];
    var rightData = datasets.filter(function (d) {
      return d.order === 1;
    })[0];
    console.log(leftData);
    console.log(rightData);
    var joinedData = joiner_node({
